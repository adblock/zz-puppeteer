/**
 * 超级推荐，钻展，获取账户报表的 url参数 dynamicToken
 */
...
function getDynamicToken(seedToken,pin, timestamp){
        let d_token = start(seedToken, pin, timestamp);
        return d_token;
}

module.exports = { getDynamicToken }