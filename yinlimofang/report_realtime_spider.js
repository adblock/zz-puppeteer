...
const { YinlimofangRealTimeSpider } = require('./class/yinlimofang_report_realtime_spider.class');
...
(async ()=>{
  ...
  // 爬虫逻辑的实例
  const ylmfRealTimeSpider = new YinlimofangRealTimeSpider({
    'crawlDate':crawlDate
  });
  // 爬虫公用逻辑实例
  const jupinSpider = new JupinSpider({
    'shopList':shopList,
    'spider': ylmfRealTimeSpider
  });
  // 启动吧
